...
//#define e_debug(fmt, arg...) IOLog("Intel82566MM debug: " fmt "\n", ## arg)
#define e_debug(fmt, arg...)
#define e_info(fmt, arg...) IOLog("Intel82566MM info: " fmt "\n", ## arg)

#define usec_delay(x) IODelay(x)
#define msec_delay(x) IODelay(x*1000)
#define msec_delay_irq(x) IODelay(x*1000)
...
struct e1000_mac_operations {
	...
	void (*update_mc_addr_list)(struct e1000_hw *, UInt8 *, UInt32, UInt32,
	                            UInt32);
...
static inline UInt32 E1000_READ_REG(struct e1000_hw* hw, UInt32 reg)
{
	UInt8* base = (UInt8*) hw->hw_addr;
	base += reg;
	return OSReadLittleInt32(base, 0);
}

static inline void E1000_WRITE_REG(struct e1000_hw* hw, UInt32 reg, UInt32 value)
{
	UInt8* base = (UInt8*) hw->hw_addr;
	base += reg;
...
static inline void E1000_WRITE_REG_ARRAY(struct e1000_hw* hw, UInt32 reg, UInt32 offset, UInt32 value)
{
	UInt8* base = (UInt8*) hw->hw_addr;
	base += reg;
	base += (offset << 2);
...
static inline UInt32 E1000_READ_REG_ARRAY(struct e1000_hw* hw, UInt32 reg, UInt32 offset)
{
	UInt8* base = (UInt8*) hw->hw_addr;
	base += reg;
	base += (offset << 2);
...
static inline void E1000_WRITE_FLASH_REG(struct e1000_hw* hw, UInt32 reg, UInt32 value) 
{
	UInt8* base = (UInt8*) hw->flash_address;
	base += reg;
	
	OSWriteLittleInt32(base, 0, value);
	OSSynchronizeIO();
}
static inline void E1000_WRITE_FLASH_REG16(struct e1000_hw* hw, UInt32 reg, UInt16 value) 
{
	UInt8* base = (UInt8*) hw->flash_address;
	base += reg;
	OSWriteLittleInt16(base, 0, value);
	OSSynchronizeIO();
}


static inline UInt32 E1000_READ_FLASH_REG(struct e1000_hw* hw, UInt32 reg)
{
	UInt8* base = (UInt8*) hw->flash_address;
	base += reg;
	return OSReadLittleInt32(base, 0);
...
static inline UInt16 E1000_READ_FLASH_REG16(struct e1000_hw* hw, UInt32 reg)
{
	UInt8* base = (UInt8*) hw->flash_address;
	base += reg;
