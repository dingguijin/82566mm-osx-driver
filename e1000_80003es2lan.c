...
static SInt32  e1000_init_phy_params_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_init_nvm_params_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_init_mac_params_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_acquire_phy_80003es2lan(struct e1000_hw *hw);
static void e1000_release_phy_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_acquire_nvm_80003es2lan(struct e1000_hw *hw);
static void e1000_release_nvm_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_read_phy_reg_gg82563_80003es2lan(struct e1000_hw *hw,
                                                   UInt32 offset,
                                                   UInt16 *data);
static SInt32  e1000_write_phy_reg_gg82563_80003es2lan(struct e1000_hw *hw,
                                                    UInt32 offset,
                                                    UInt16 data);
static SInt32  e1000_write_nvm_80003es2lan(struct e1000_hw *hw, UInt16 offset,
                                        UInt16 words, UInt16 *data);
static SInt32  e1000_get_cfg_done_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_phy_force_speed_duplex_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_get_cable_length_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_get_link_up_info_80003es2lan(struct e1000_hw *hw, UInt16 *speed,
                                               UInt16 *duplex);
static SInt32  e1000_reset_hw_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_init_hw_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_setup_copper_link_80003es2lan(struct e1000_hw *hw);
static void e1000_clear_hw_cntrs_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_acquire_swfw_sync_80003es2lan(struct e1000_hw *hw, UInt16 mask);
static SInt32  e1000_cfg_kmrn_10_100_80003es2lan(struct e1000_hw *hw, UInt16 duplex);
static SInt32  e1000_cfg_kmrn_1000_80003es2lan(struct e1000_hw *hw);
static SInt32  e1000_copper_link_setup_gg82563_80003es2lan(struct e1000_hw *hw);
static void e1000_initialize_hw_bits_80003es2lan(struct e1000_hw *hw);
static void e1000_release_swfw_sync_80003es2lan(struct e1000_hw *hw, UInt16 mask);
static SInt32  e1000_read_mac_addr_80003es2lan(struct e1000_hw *hw);
...
static SInt32 e1000_init_phy_params_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_phy_params_80003es2lan");
...
static SInt32 e1000_init_nvm_params_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_nvm_params_80003es2lan");
...
static SInt32 e1000_init_mac_params_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_mac_params_80003es2lan");
...
{
	e_debug("e1000_init_function_pointers_80003es2lan");
...
static SInt32 e1000_acquire_phy_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_acquire_phy_80003es2lan");
...
static void e1000_release_phy_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_release_phy_80003es2lan");
...
static SInt32 e1000_acquire_nvm_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_acquire_nvm_80003es2lan");
...
static void e1000_release_nvm_80003es2lan(struct e1000_hw *hw)
{
	e_debug("e1000_release_nvm_80003es2lan");
...
static SInt32 e1000_acquire_swfw_sync_80003es2lan(struct e1000_hw *hw, UInt16 mask)
{
	...
	SInt32 ret_val = E1000_SUCCESS;
	SInt32 i = 0, timeout = 200;

	e_debug("e1000_acquire_swfw_sync_80003es2lan");
	...
	if (i == timeout) {
		e_debug("Driver can't access resource, SW_FW_SYNC timeout.\n");
		ret_val = -E1000_ERR_SWFW_SYNC;
		goto out;
	}
...
static void e1000_release_swfw_sync_80003es2lan(struct e1000_hw *hw, UInt16 mask)
{
	...
	e_debug("e1000_release_swfw_sync_80003es2lan");
                                                  ...
                                                  UInt32 offset, UInt16 *data)
{
	...
	e_debug("e1000_read_phy_reg_gg82563_80003es2lan");
                                                   ...
                                                   UInt32 offset, UInt16 data)
{
	...
	e_debug("e1000_write_phy_reg_gg82563_80003es2lan");
...
static SInt32 e1000_write_nvm_80003es2lan(struct e1000_hw *hw, UInt16 offset,
                            UInt16 words, UInt16 *data)
{
	e_debug("e1000_write_nvm_80003es2lan");
...
static SInt32 e1000_get_cfg_done_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_get_cfg_done_80003es2lan");
...
static SInt32 e1000_phy_force_speed_duplex_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_phy_force_speed_duplex_80003es2lan");
	...
	if (hw->phy.autoneg_wait_to_complete) {
		e_debug("Waiting for forced speed/duplex link "
		         "on GG82563 phy.\n");
...
static SInt32 e1000_get_cable_length_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_get_cable_length_80003es2lan");
                                              ...
                                              UInt16 *duplex)
{
	...
	e_debug("e1000_get_link_up_info_80003es2lan");
...
static SInt32 e1000_reset_hw_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_reset_hw_80003es2lan");
...
static SInt32 e1000_init_hw_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_hw_80003es2lan");
...
static void e1000_initialize_hw_bits_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_initialize_hw_bits_80003es2lan");
...
static SInt32 e1000_copper_link_setup_gg82563_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_copper_link_setup_gg82563_80003es2lan");
...
static SInt32 e1000_setup_copper_link_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_setup_copper_link_80003es2lan");
...
static SInt32 e1000_cfg_kmrn_10_100_80003es2lan(struct e1000_hw *hw, UInt16 duplex)
{
	...
	e_debug("e1000_configure_kmrn_for_10_100");
...
static SInt32 e1000_cfg_kmrn_1000_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_configure_kmrn_for_1000");
...
static SInt32 e1000_read_mac_addr_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_read_mac_addr_80003es2lan");
...
static void e1000_clear_hw_cntrs_80003es2lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_clear_hw_cntrs_80003es2lan");
