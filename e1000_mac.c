...
void e1000_init_mac_ops_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_mac_ops_generic");
...
{
	e_debug("e1000_remove_device_generic");
	...
	if (hw->dev_spec) {
		IOFree(hw->dev_spec, hw->dev_spec_size);
		hw->dev_spec = NULL;
	}
}
...
void e1000_clear_vfta_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_clear_vfta_generic");
...
{
	e_debug("e1000_write_vfta_generic");
...
void e1000_init_rx_addrs_generic(struct e1000_hw *hw, UInt16 rar_count)
{
	...
	e_debug("e1000_init_rx_addrs_generic");

	/* Setup the receive address */
	e_debug("Programming MAC Address into RAR[0]\n");

	hw->mac.ops.rar_set(hw, hw->mac.addr, 0);

	/* Zero out the other (rar_entry_count - 1) receive addresses */
	e_debug("Clearing RAR[1-%u]\n", rar_count-1);
...
SInt32 e1000_check_alt_mac_addr_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_alt_mac_addr_generic");
	...
	if (hw->bus.func == E1000_FUNC_1)
		nvm_alt_mac_addr_offset += ETH_ADDR_LEN/sizeof(UInt16);
...
{
	UInt32 hash_bit, hash_reg, mta;

	e_debug("e1000_mta_set_generic");
	/*
                                       ...
                                       UInt32 rar_used_count, UInt32 rar_count)
{
	...
	e_debug("e1000_update_mc_addr_list_generic");
...
UInt32 e1000_hash_mc_addr_generic(struct e1000_hw *hw, UInt8 *mc_addr)
{
	...
	e_debug("e1000_hash_mc_addr_generic");
...
void e1000_clear_hw_cntrs_base_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_clear_hw_cntrs_base_generic");
...
SInt32 e1000_check_for_copper_link_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_for_copper_link");
	...
	if (ret_val) {
		e_debug("Error configuring flow control\n");
	}
...
SInt32 e1000_check_for_fiber_link_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_for_fiber_link_generic");
	...
	if ((ctrl & E1000_CTRL_SWDPIN1) && (!(status & E1000_STATUS_LU)) &&
		...
		e_debug("NOT RXing /C/, disable AutoNeg and force link.\n");
		 ...
		 */
		e_debug("RXing /C/, enable AutoNeg and stop forcing link.\n");
...
SInt32 e1000_check_for_serdes_link_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_for_serdes_link_generic");
	...
	if ((!(status & E1000_STATUS_LU)) && (!(rxcw & E1000_RXCW_C))) {
		...
		if (E1000_RXCW_SYNCH & E1000_READ_REG(hw, E1000_RXCW)) {
			if (!(rxcw & E1000_RXCW_IV)) {
				mac->serdes_has_link = true;
				e_debug("SERDES: Link is up.\n");
			}
		} else {
			mac->serdes_has_link = false;
			e_debug("SERDES: Link is down.\n");
		}
	}
...
SInt32 e1000_setup_link_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_setup_link_generic");
	 ...
	 */
	e_debug("Initializing the Flow Control address, type and timer regs\n");
...
SInt32 e1000_setup_fiber_serdes_link_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_setup_fiber_serdes_link_generic");
	 ...
	 */
	e_debug("Auto-negotiation enabled\n");
...
void e1000_config_collision_dist_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_config_collision_dist_generic");
...
SInt32 e1000_poll_fiber_serdes_link_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_poll_fiber_serdes_link_generic");
	...
	if (i == FIBER_LINK_UP_LIMIT) {
		e_debug("Never got a valid link from auto-neg!!!\n");
		mac->autoneg_failed = 1;
		/*
		...
		if (ret_val) {
			e_debug("Error while checking for link\n");
			goto out;
		}
		mac->autoneg_failed = 0;
	} else {
		mac->autoneg_failed = 0;
		e_debug("Valid Link Found\n");
	}
...
SInt32 e1000_commit_fc_settings_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_commit_fc_settings_generic");
...
SInt32 e1000_set_fc_watermarks_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_set_fc_watermarks_generic");
...
SInt32 e1000_set_default_fc_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_set_default_fc_generic");
...
SInt32 e1000_force_mac_fc_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_force_mac_fc_generic");
...
SInt32 e1000_config_fc_after_link_up_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_config_fc_after_link_up_generic");
	...
	if (ret_val) {
		e_debug("Error forcing flow control settings\n");
		goto out;
	}
	...
	if ((hw->phy.media_type == e1000_media_type_copper) && mac->autoneg) {
		...
		if (!(mii_status_reg & MII_SR_AUTONEG_COMPLETE)) {
			e_debug("Copper PHY and Auto Neg "
			         "has not completed.\n");
			goto out;
		}
		...
		if ((mii_nway_adv_reg & NWAY_AR_PAUSE) &&
			...
			if (hw->fc.original_type == e1000_fc_full) {
				hw->fc.type = e1000_fc_full;
				e_debug("Flow Control = FULL.\r\n");
			} else {
				hw->fc.type = e1000_fc_rx_pause;
				e_debug("Flow Control = "
		 ...
		 */
			...
			hw->fc.type = e1000_fc_tx_pause;
			e_debug("Flow Control = TX PAUSE frames only.\r\n");
		}
		/*
		 ...
		 */
		         ...
		         (mii_nway_lp_ability_reg & NWAY_LPAR_ASM_DIR)) {
			hw->fc.type = e1000_fc_rx_pause;
			e_debug("Flow Control = RX PAUSE frames only.\r\n");
		} else {
			/*
		...
		if (ret_val) {
			e_debug("Error getting link speed and duplex\n");
			goto out;
		}
 ...
 **/
SInt32 e1000_get_speed_and_duplex_copper_generic(struct e1000_hw *hw, UInt16 *speed,
                                              UInt16 *duplex)
{
	UInt32 status;

	e_debug("e1000_get_speed_and_duplex_copper_generic");
 ...
 **/
SInt32 e1000_get_speed_and_duplex_fiber_serdes_generic(struct e1000_hw *hw,
                                                    UInt16 *speed, UInt16 *duplex)
{
	e_debug("e1000_get_speed_and_duplex_fiber_serdes_generic");
...
SInt32 e1000_get_hw_semaphore_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_get_hw_semaphore_generic");
	...
	if (i == timeout) {
		e_debug("Driver can't access device - SMBI bit is set.\n");
...
void e1000_put_hw_semaphore_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_put_hw_semaphore_generic");
...
SInt32 e1000_get_auto_rd_done_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_get_auto_rd_done_generic");
	...
	if (i == AUTO_READ_DONE_TIMEOUT) {
		e_debug("Auto read by HW from NVM has not completed.\n");
 ...
 **/
SInt32 e1000_valid_led_default_generic(struct e1000_hw *hw, UInt16 *data)
{
	SInt32 ret_val;

	e_debug("e1000_valid_led_default_generic");
...
SInt32 e1000_id_led_init_generic(struct e1000_hw * hw)
{
	...
	e_debug("e1000_id_led_init_generic");
...
SInt32 e1000_setup_led_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_setup_led_generic");
...
SInt32 e1000_cleanup_led_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_cleanup_led_generic");
...
SInt32 e1000_blink_led_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_blink_led_generic");
...
void e1000_set_pcie_no_snoop_generic(struct e1000_hw *hw, UInt32 no_snoop)
{
	...
	e_debug("e1000_set_pcie_no_snoop_generic");
...
{
	UInt32 ctrl;
	SInt32 timeout = MASTER_DISABLE_TIMEOUT;
	SInt32 ret_val = E1000_SUCCESS;

	e_debug("e1000_disable_pcie_master_generic");
	...
	if (!timeout) {
		e_debug("Master requests are pending.\n");
...
void e1000_reset_adaptive_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_reset_adaptive_generic");

	if (!mac->adaptive_ifs) {
		e_debug("Not in Adaptive IFS mode!\n");
		goto out;
	}
...
void e1000_update_adaptive_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_update_adaptive_generic");
...
SInt32 e1000_validate_mdi_setting_generic(struct e1000_hw *hw)
{
	...
	e_debug("e1000_validate_mdi_setting_generic");

	if (!hw->mac.autoneg && (hw->phy.mdix == 0 || hw->phy.mdix == 3)) {
		e_debug("Invalid MDI setting detected\n");
		hw->phy.mdix = 1;
		ret_val = -E1000_ERR_CONFIG;
		goto out;
	}
 ...
 *  completion.
 **/
SInt32 e1000_write_8bit_ctrl_reg_generic(struct e1000_hw *hw, UInt32 reg,
                                      UInt32 offset, UInt8 data)
{
	UInt32 i, regvalue = 0;
	SInt32 ret_val = E1000_SUCCESS;

	e_debug("e1000_write_8bit_ctrl_reg_generic");
	...
	if (!(regvalue & E1000_GEN_CTL_READY)) {
		e_debug("Reg %08x did not indicate ready\n", reg);
