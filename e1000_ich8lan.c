...
static SInt32  e1000_init_phy_params_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_init_nvm_params_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_init_mac_params_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_acquire_swflag_ich8lan(struct e1000_hw *hw);
static void e1000_release_swflag_ich8lan(struct e1000_hw *hw);
static bool e1000_check_mng_mode_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_check_polarity_ife_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_check_reset_block_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_phy_force_speed_duplex_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_phy_hw_reset_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_get_phy_info_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_set_d0_lplu_state_ich8lan(struct e1000_hw *hw,
                                            bool active);
static SInt32  e1000_set_d3_lplu_state_ich8lan(struct e1000_hw *hw,
                                            bool active);
static SInt32  e1000_read_nvm_ich8lan(struct e1000_hw *hw, UInt16 offset,
                                   UInt16 words, UInt16 *data);
static SInt32  e1000_write_nvm_ich8lan(struct e1000_hw *hw, UInt16 offset,
                                    UInt16 words, UInt16 *data);
static SInt32  e1000_validate_nvm_checksum_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_update_nvm_checksum_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_valid_led_default_ich8lan(struct e1000_hw *hw,
                                            UInt16 *data);
static SInt32  e1000_reset_hw_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_init_hw_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_setup_link_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_setup_copper_link_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_get_link_up_info_ich8lan(struct e1000_hw *hw,
                                           UInt16 *speed, UInt16 *duplex);
static SInt32  e1000_cleanup_led_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_led_on_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_led_off_ich8lan(struct e1000_hw *hw);
static void e1000_clear_hw_cntrs_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_erase_flash_bank_ich8lan(struct e1000_hw *hw, UInt32 bank);
static SInt32  e1000_flash_cycle_ich8lan(struct e1000_hw *hw, UInt32 timeout);
static SInt32  e1000_flash_cycle_init_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_get_phy_info_ife_ich8lan(struct e1000_hw *hw);
static void e1000_initialize_hw_bits_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_kmrn_lock_loss_workaround_ich8lan(struct e1000_hw *hw);
static SInt32  e1000_read_flash_byte_ich8lan(struct e1000_hw *hw,
                                          UInt32 offset, UInt8* data);
static SInt32  e1000_read_flash_data_ich8lan(struct e1000_hw *hw, UInt32 offset,
                                          UInt8 size, UInt16* data);
static SInt32  e1000_read_flash_word_ich8lan(struct e1000_hw *hw,
                                          UInt32 offset, UInt16 *data);
static SInt32  e1000_retry_write_flash_byte_ich8lan(struct e1000_hw *hw,
                                                 UInt32 offset, UInt8 byte);
static SInt32  e1000_write_flash_byte_ich8lan(struct e1000_hw *hw,
                                           UInt32 offset, UInt8 data);
static SInt32  e1000_write_flash_data_ich8lan(struct e1000_hw *hw, UInt32 offset,
                                           UInt8 size, UInt16 data);
static SInt32 e1000_get_cfg_done_ich8lan(struct e1000_hw *hw);
...
static SInt32 e1000_init_phy_params_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_phy_params_ich8lan");
	...
	if (ret_val) {
		...
		ret_val = e1000_determine_phy_address(hw);
		if (ret_val) {
			e_debug("Cannot determine PHY address. Erroring out\n");
			goto out;
		}
	}
...
static SInt32 e1000_init_nvm_params_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_nvm_params_ich8lan");

	/* Can't read flash registers if the register set isn't mapped. */
	if (!hw->flash_address) {
		e_debug("ERROR: Flash registers not mapped\n");
	...
	if (!dev_spec) {
		e_debug("dev_spec pointer is set to NULL.\n");
		ret_val = -E1000_ERR_CONFIG;
		goto out;
	}
...
static SInt32 e1000_init_mac_params_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_init_mac_params_ich8lan");
...
{
	e_debug("e1000_init_function_pointers_ich8lan");
...
static SInt32 e1000_acquire_swflag_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_acquire_swflag_ich8lan");
	...
	if (!timeout) {
		e_debug("FW or HW has locked the resource for too long.\n");
		extcnf_ctrl &= ~E1000_EXTCNF_CTRL_SWFLAG;
		E1000_WRITE_REG(hw, E1000_EXTCNF_CTRL, extcnf_ctrl);
		ret_val = -E1000_ERR_CONFIG;
		goto out;
...
static void e1000_release_swflag_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_release_swflag_ich8lan");
...
static bool e1000_check_mng_mode_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_mng_mode_ich8lan");
...
static SInt32 e1000_check_reset_block_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_reset_block_ich8lan");
...
static SInt32 e1000_phy_force_speed_duplex_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_phy_force_speed_duplex_ich8lan");
	...
	if (phy->autoneg_wait_to_complete) {
		e_debug("Waiting for forced speed/duplex link on IFE phy.\n");
		...
		if (!link) {
			e_debug("Link taking longer than expected.\n");
		}
...
static SInt32 e1000_phy_hw_reset_ich8lan(struct e1000_hw *hw)
{
	...
	SInt32 ret_val;
	UInt16 loop = E1000_ICH8_LAN_INIT_TIMEOUT;
	UInt16 word_addr, reg_data, reg_addr, phy_page = 0;

	e_debug("e1000_phy_hw_reset_ich8lan");
	...
	if (hw->mac.type == e1000_ich8lan && phy->type == e1000_phy_igp_3) {
		 ...
		 */
		if (loop == 0) {
			e_debug("LAN_INIT_DONE not set, increase timeout\n");
		}
...
static SInt32 e1000_get_phy_info_ich8lan(struct e1000_hw *hw)
{
	SInt32 ret_val = -E1000_ERR_PHY_TYPE;

	e_debug("e1000_get_phy_info_ich8lan");
...
static SInt32 e1000_get_phy_info_ife_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_get_phy_info_ife_ich8lan");
	...
	if (!link) {
		e_debug("Phy info is only valid if link is up\n");
		ret_val = -E1000_ERR_CONFIG;
		goto out;
	}
...
static SInt32 e1000_check_polarity_ife_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_check_polarity_ife_ich8lan");
                                           ...
                                           bool active)
{
	...
	e_debug("e1000_set_d0_lplu_state_ich8lan");
                                           ...
                                           bool active)
{
	...
	e_debug("e1000_set_d3_lplu_state_ich8lan");
 ...
 **/
static SInt32 e1000_valid_nvm_bank_detect_ich8lan(struct e1000_hw *hw, UInt32 *bank)
{
	SInt32 ret_val = E1000_SUCCESS;
	struct e1000_nvm_info *nvm = &hw->nvm;
			...
			*bank = 0;
			...
			if ((bank_high_byte & 0xC0) == 0x80) {
				*bank = 1;
				...
				e_debug("ERROR: EEPROM not present\n");
				ret_val = -E1000_ERR_NVM;
			}
		}
	} else {
		e_debug("DEV SPEC is NULL\n");
		ret_val = -E1000_ERR_NVM;
	}
 ...
 **/
static SInt32 e1000_read_nvm_ich8lan(struct e1000_hw *hw, UInt16 offset, UInt16 words,
                                  UInt16 *data)
{
	struct e1000_nvm_info *nvm = &hw->nvm;
	struct e1000_dev_spec_ich8lan *dev_spec;
	...
	e_debug("e1000_read_nvm_ich8lan");
...
static SInt32 e1000_flash_cycle_init_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_flash_cycle_init_ich8lan");

	hsfsts.regval = E1000_READ_FLASH_REG16(hw, ICH_FLASH_HSFSTS);

	/* Check if the flash descriptor is valid */
	if (hsfsts.hsf_status.fldesvalid == 0) {
		e_debug("Flash descriptor invalid.  "
	...
	if (hsfsts.hsf_status.flcinprog == 0) {
		...
		if (ret_val == E1000_SUCCESS) {
			...
			e_debug("Flash controller busy, cannot get access");
		}
	}
...
static SInt32 e1000_flash_cycle_ich8lan(struct e1000_hw *hw, UInt32 timeout)
{
	...
	e_debug("e1000_flash_cycle_ich8lan");
 ...
 **/
static SInt32 e1000_read_flash_word_ich8lan(struct e1000_hw *hw, UInt32 offset,
                                         UInt16 *data)
{
	SInt32 ret_val;

	e_debug("e1000_read_flash_word_ich8lan");
 ...
 **/
static SInt32 e1000_read_flash_byte_ich8lan(struct e1000_hw *hw, UInt32 offset,
                                         UInt8* data)
{
	SInt32 ret_val = E1000_SUCCESS;
	UInt16 word = 0;
                                         ...
                                         UInt8 size, UInt16* data)
{
	...
	e_debug("e1000_read_flash_data_ich8lan");
	...
	do {
		...
		if (ret_val == E1000_SUCCESS) {
			...
			if (hsfsts.hsf_status.flcerr == 1) {
				...
				e_debug("Timeout error - flash cycle "
				         "did not complete.");
				break;
			}
		}
 ...
 **/
static SInt32 e1000_write_nvm_ich8lan(struct e1000_hw *hw, UInt16 offset, UInt16 words,
                                   UInt16 *data)
{
	struct e1000_nvm_info *nvm = &hw->nvm;
	struct e1000_dev_spec_ich8lan *dev_spec;
	...
	e_debug("e1000_write_nvm_ich8lan");
...
static SInt32 e1000_update_nvm_checksum_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_update_nvm_checksum_ich8lan");
...
static SInt32 e1000_validate_nvm_checksum_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_validate_nvm_checksum_ich8lan");
 ...
 **/
static SInt32 e1000_write_flash_byte_ich8lan(struct e1000_hw *hw, UInt32 offset,
                                          UInt8 data)
{
	UInt16 word = (UInt16)data;

	e_debug("e1000_write_flash_byte_ich8lan");
                                                ...
                                                UInt32 offset, UInt8 byte)
{
	...
	e_debug("e1000_retry_write_flash_byte_ich8lan");
	...
	for (program_retries = 0; program_retries < 100; program_retries++) {
		e_debug("Retrying Byte %2.2X at offset %u\n", byte, offset);
		usec_delay(100);
		ret_val = e1000_write_flash_byte_ich8lan(hw, offset, byte);
		if (ret_val == E1000_SUCCESS)
			break;
...
static SInt32 e1000_erase_flash_bank_ich8lan(struct e1000_hw *hw, UInt32 bank)
{
	...
	SInt32  ret_val = E1000_SUCCESS;
	SInt32  count = 0;
	SInt32  j, iteration, sector_size;

	e_debug("e1000_erase_flash_bank_ich8lan");
 ...
 *  setting.
 **/
static SInt32 e1000_valid_led_default_ich8lan(struct e1000_hw *hw, UInt16 *data)
{
	SInt32 ret_val;

	e_debug("e1000_valid_led_default_ich8lan");
...
static SInt32 e1000_reset_hw_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_reset_hw_ich8lan");
	...
	e_debug("Issuing a global reset to ich8lan");
	...
	if (ret_val) {
		 ...
		 */
		e_debug("Auto Read Done did not complete\n");
	}
...
static void e1000_initialize_hw_bits_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_initialize_hw_bits_ich8lan");
...
static SInt32 e1000_setup_link_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_setup_link_ich8lan");
	...
	e_debug("After fix-ups FlowControl is now = %x\n", hw->fc.type);
...
static SInt32 e1000_setup_copper_link_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_setup_copper_link_ich8lan");
 ...
 *  gigabit speeds.
 **/
static SInt32 e1000_get_link_up_info_ich8lan(struct e1000_hw *hw, UInt16 *speed,
                                          UInt16 *duplex)
{
	SInt32 ret_val;

	e_debug("e1000_get_link_up_info_ich8lan");
...
static SInt32 e1000_kmrn_lock_loss_workaround_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_kmrn_lock_loss_workaround_ich8lan");
                                                 ...
                                                 bool state)
{
	...
	e_debug("e1000_set_kmrn_lock_loss_workaround_ich8lan");

	if (hw->mac.type != e1000_ich8lan) {
		e_debug("Workaround applies to ICH8 only.\n");
		goto out;
	}
...
void e1000_igp3_phy_powerdown_workaround_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_igp3_phy_powerdown_workaround_ich8lan");
...
void e1000_gig_downshift_workaround_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_gig_downshift_workaround_ich8lan");
...
static SInt32 e1000_cleanup_led_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_cleanup_led_ich8lan");
...
static void e1000_clear_hw_cntrs_ich8lan(struct e1000_hw *hw)
{
	...
	e_debug("e1000_clear_hw_cntrs_ich8lan");
